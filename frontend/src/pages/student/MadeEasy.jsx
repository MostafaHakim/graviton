...
const MadeEasy = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#17202F] via-[#134C45] to-[#3BD480] lg:rounded-2xl">
            ...
            >
              ...
              <div className="font-kalpurush">
                ...
                <div className="flex items-center justify-center space-x-2">
                  <GraduationCap className="w-6 h-6 text-[#3BD480]" />
                  <h2 className="text-2xl md:text-3xl text-white/90 capitalize">
                    ক্লাস {user?.class}
                  </h2>
                </div>
              </div>
              ...
              >
                আপনার ক্লাসের সকল বিষয় এখানে সাজানো রয়েছে। সহজ ও কার্যকরী
                শিক্ষার জন্য নির্বাচন করুন আপনার পছন্দের বিষয়।
              </motion.p>
            </motion.div>
