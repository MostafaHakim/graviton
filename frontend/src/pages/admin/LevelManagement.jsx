...
import FlashCardLevelModal from "../../components/FlashCardLevelModal";
...
const LevelManagement = () => {
  ...
  const { flashCategorys, levels, loading } = useSelector(
    (state) => state.flashs,
  );
  ...
  const selectedCategory = flashCategorys.find((cat) => cat._id === id);

  const handleAddLevel = async (data) => {
    const res = await dispatch(createFlashLevel(data));
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm">Loading levels...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="border-b border-gray-200 bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-3">
            ...
            <span className="text-gray-900 font-medium">Level Management</span>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="text-3xl md:text-4xl font-light tracking-tight text-gray-900 mb-2">
              {selectedCategory?.title || "Flashcard Category"}
            </h1>
          ...
          <div className="text-center py-16 px-4">
            <div className="max-w-sm mx-auto">
              ...
              <p className="text-gray-500 text-sm mb-6">
                Start by creating your first flashcard level for{" "}
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="text-sm font-medium text-gray-900 mb-1">
                About Flashcard Levels
              </h4>
              <p className="text-sm text-gray-500">
                Levels help you organize flashcards by difficulty or topic.
                Create multiple levels within each category to structure your
