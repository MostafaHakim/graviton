...
// CloudinaryPage component for the flipbook
const CloudinaryPage = forwardRef(({ url, pageNumber }, ref) => (
  <div
    className="bg-white shadow-xl flex justify-center items-center overflow-hidden border border-gray-200"
    ref={ref}
...
const PartManagement = () => {
  ...
  const handleBack = () => {
    navigate(`/abord-test/${classId}/${subjectId}`);
  };
  ...
  if (chapterLoading || testsLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm">Loading part details...</p>
        </div>
      </div>
    );
  }

  if (reduxError || (!chapterLoading && !chapter)) {
    return (
      ...
      <div className="border-b border-gray-200 bg-white/50 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <ChevronRight size={16} />
            <Link
              to={`/abord-test/${classId}/${subjectId}`}
              className="hover:text-gray-900 transition-colors"
            >
              Type
            </Link>
              ...
              {tests && tests.length > 0 ? (
                  ...
                  {tests.map((test) => (
                    ...
                    >
                      ...
                      <div className="p-5">
                        ...
                        <Link to={test._id} className="block">
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 text-sm mb-6">
                    এই পার্টের জন্য প্রথম পরীক্ষা যোগ করুন
                  </p>
                  <Link
                    to="newtest"
                    className="inline-flex items-center gap-2 px-4 py-2 bg-gray-900 text-white text-sm rounded-lg hover:bg-gray-800 transition-colors"
