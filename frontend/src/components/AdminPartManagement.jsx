...
// export default function AdminPartManagement() {
...
export default function AdminPartManagement() {
  ...
  const addQuestion = async (e) => {
    ...
    await fetch(`${import.meta.env.VITE_BASE_URL}/api/tests/questions`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        testId: selectedTest._id,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="text-3xl md:text-4xl font-light tracking-tight text-gray-900 mb-2">
              Part Test Management
            </h1>
            <p className="text-gray-500 text-sm max-w-2xl">
              Create and manage tests for this skill part
            </p>
          </div>
        </div>
      </div>
            ...
            <div>
              ...
              <form onSubmit={createTest} className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="e.g., Part 1: Listening Comprehension"
                    value={testTitle}
                    onChange={(e) => setTestTitle(e.target.value)}
                ...
                <div className="flex items-center gap-2">
                  ...
                  {csvFile && (
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-4 py-2 text-sm text-gray-600 hover:text-gray-900 transition-colors border border-gray-300 rounded-lg hover:bg-gray-50"
                    >
                      <X size={16} />
                      Clear
                    </button>
