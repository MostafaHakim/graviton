  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.photoFile) {
        photoData = await uploadPhotoToCloudinary(formData.photoFile);
      }
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Assistant Teacher / Professor"
                className="w-full border border-gray-200 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-gray-900"
              />
            </div>
